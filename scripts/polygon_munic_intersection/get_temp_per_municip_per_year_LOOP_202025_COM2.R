...
saveRDS(result_all, here("output/temp_all_Fr_per_year/8km_munic_polygon_com2", "2020_2025.rds"))
result_all_2020_2025 <- readRDS(here("output/temp_all_Fr_per_year/8km_munic_polygon_com2", "2020_2025.rds"))
...
com2_temp_final <- merge(result_all_2020_2025, com2df, by = "INSEE_COM", all.x = TRUE)
# add region number
reg <- grid %>%
...
saveRDS(com2_temp_final, here("output/temp_all_Fr_per_year", "2020_2025_with_dep_reg_nb.rds"))
result_all_2020_2025 <- readRDS(here("output/temp_all_Fr_per_year", "2020_2025_with_dep_reg_nb.rds"))
...
# mapview(u, zcol="temp_mean",at = seq(2, 20, 5))
